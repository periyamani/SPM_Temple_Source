...
@section('content') 
    ...
    <div class="text-center padding--top" style="background:white;">
                    ...
                    <h3 class="m-0">Festival Details</h3>
                ...
                <div class="row g-4">
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar__tab">
                                ...
                                <div class="section__wrapper">
                                    ...
                                    @php $festival = DB::table('festival')->where('active', '1')->orderBy('id','desc')->limit(3)->get();@endphp
                                                    ...
                                                    <div class="footer__post-item">
                                                        <div class="footer__post-inner">
                                                            ...
                                                            <div class="footer__post-thumb">
                                                                <a href="/user/festivaldetail_page/{{$festi->id}}"> <?php $video=explode(' /', $festi->video); $video_im=explode('.', $video[0]);
                    $url=asset("");
                   if($video_im[1]=='mp4'){
                   ...
                   ?></a>
                                                            ...
                                                            <div class="footer__post-content">
                                                                <a href="/user/festivaldetail_page/{{$festi->id}}"><h6>{{$festi->title}}</h6></a>
