...
@section('content') 
    ...
    <div class="text-center padding--top" style="background:white;">
                    ...
                    <h3 class="m-0">Events Details</h3>
 ...
 <div class="col-lg-12 col-12">
                        <div class="row g-4">
                            ...
                            <div class="event__inner">
                                ...
                                <div class="blog__slider overflow-hidden">
                                    ...
                                    <?php $video=explode(' /', $form->fevideo);
                   ...
                   if($video_im[1]=='mp4'){
                       ...
                       <div class="blog__slider-item">
                           <div class="blog__slider-thumb">
                               <a href="#"><video src="'.$url.'festival/'.$value.'" class="festival_align" controls ></video></a>
                           </div>
                       </div>
                   </div>';
                   }else{
                    ...
                    <div class="blog__slider-item">
                        <div class="blog__slider-thumb">
                            <a href="#"><img src="'.$url.'festival/'.$value.'" class="festival_align"></a>
                        </div>
                    </div>
                </div>';
                   }
                             ...
                             <!-- end slideshow -->
                                        ...
                                        <div class="blog__content">
                                           <h3>{{$form->fetitle}}</h3>
                                            ...
                                            <li><i class="far fa-clock"></i> {{$form->fetime}}</li>
                                                <li><i class="far fa-calendar"></i> {{$form->fedate}}</li>
                                               
                                            </ul>
                                            <p>{{$form->fedescripion}}</p>
                   ...
                   if($video_im[1]=='mp4'){
                       ...
                       <div class="blog__slider-item">
                           <div class="blog__slider-thumb">
                               <a href="#"><video src="'.$url.'events/'.$value.'" class="festival_align" controls ></video></a>
                           </div>
                       </div>
                   </div>';
                   }else{
                    ...
                    <div class="blog__slider-item">
                        <div class="blog__slider-thumb">
                            <a href="#"><img src="'.$url.'events/'.$value.'" class="festival_align"></a>
                        </div>
                    </div>
                </div>';
                   }
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar__tab">
                                ...
                                <div class="section__wrapper">
                                    ...
                                    @php $festival = DB::table('event')->where('active', '1')->orderBy('id','desc')->limit(3)->get();@endphp
                                                    ...
                                                    <div class="footer__post-item">
                                                        <div class="footer__post-inner">
                                                            ...
                                                            <div class="footer__post-thumb">
                                                                <a href="/user/eventsdetail_page/{{$festi->id}}"> <?php $video=explode(' /', $festi->video); $video_im=explode('.', $video[0]);
                    $url=asset("");
                   if($video_im[1]=='mp4'){
                   ...
                   ?></a>
                                                            ...
                                                            <div class="footer__post-content">
                                                                <a href="/user/eventsdetail_page/{{$festi->id}}"><h6>{{$festi->title}}</h6></a>
