    ...
    <div class="banner__slider  banner-style3 overflow-hidden">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="banner" style="background-image: url({{URL::asset('slider/slide.JPG')}}); height: 700px;">
                    <div class="container">
                        <div class="banner__content ">
                            <!-- <h2 class="text-white">Gratest God</h2>
                            <p class="text-white" >Sri puthu mariyamman temple 1,000-year
            ...
            <div class="swiper-slide">
            <div class="banner" style="background-image: url({{URL::asset('slider/front.JPG')}}); height: 700px;">
                    <div class="container">
                        <div class="banner__content ">
            ...
            <div class="swiper-slide">
                <div class="banner" style="background-image: url({{URL::asset('slider/front2.JPG')}}); height: 700px;">
                    <div class="container">
                        <div class="banner__content ">
...
<script>
  ...
  $("#video-overlay").append('<iframe width="560" height="315" src="slider/demo-vdo.mp4" frameborder="0" allowfullscreen></iframe>');
});
