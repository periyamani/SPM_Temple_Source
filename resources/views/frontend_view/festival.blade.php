 ...
 <div class="event padding--top padding--bottom bg-light">
        <div class="container">
            ...
            <div class="section__wrapper" id="test-list">
                ...
                @php $festival = DB::table('festival')->where('active', '1')->orderBy('id','desc')->limit(10)->get();@endphp
                   ...
                   if($video_im[1]=='mp4'){
                       ...
                       <div class="blog__slider-item">
                           <div class="blog__slider-thumb">
                               <a href="/user/festivaldetail_page/'.$festi->id.'"><video src="'.$url.'festival/'.$value.'" class="festival_align" controls ></video></a>
                           </div>
                       </div>
                   </div>';
                   }else{
                    ...
                    <div class="blog__slider-item">
                        <div class="blog__slider-thumb">
                            <a href="/user/festivaldetail_page/'.$festi->id.'"><img src="'.$url.'festival/'.$value.'" class="festival_align"></a>
                        </div>
                    </div>
                </div>';
                   }
                   ...
                   ?>
                                ...
                                <div class="event__content">
                                    <a href="/user/festivaldetail_page/{{$festi->id}}"><h5>{{$festi->title}}</h5></a>
