...
@section('content') 
	...
	<div class="card-body padding--top" style="overflow: auto;">
							<div class="card-title display-inline">
								<!-- <h4 class="mb-0 leave_add_res_title text-center">Dharmagrtha Family Tree</h4> -->
                <div class="card-title display-inline section__header text-center">
                <h2 class="">Dharmagrtha Family Tree</h2>
            </div>
</div>
...
<input type="radio" class="btn-check button_click active_api_run" name="btnradio" id="btnradio1" onclick=" fullvalue('all')" checked="" autocomplete="off">
                ...
                <label class="btn btn_focus btn-outline-primary" for="btnradio2">This year dharmagrtha</label>
              </div>
        ...
        success: function(data) {
            ...
            $.each(data, function(key, val) {
                if(val.child_number==0){
                    ...
                    +'<div class="pt-thumb">'
                    +'<img src="{{URL::asset("dharmagartha")}}/'+val.photo+'" style="width: 100%; height: 100%;">'
                    +'</div>'
