 ...
 <div class="event padding--top padding--bottom bg-light">
        <div class="container">
            ...
            <div class="section__wrapper" id="test-list">
                ...
                @php $festival = DB::table('event')->where('active', '1')->orderBy('id','desc')->get();@endphp
                   ...
                   if($video_im[1]=='mp4'){
                       ...
                       <div class="blog__slider-item">
                           <div class="blog__slider-thumb">
                               <a href="/user/eventsdetail_page/'.$festi->id.'"><video src="'.$url.'events/'.$value.'" class="festival_align" controls ></video></a>
                           </div>
                       </div>
                   </div>';
                   }else{
                    ...
                    <div class="blog__slider-item">
                        <div class="blog__slider-thumb">
                            <a href="/user/eventsdetail_page/'.$festi->id.'"><img src="'.$url.'events/'.$value.'" class="festival_align"></a>
                        </div>
                    </div>
                </div>';
                   }
                   ...
                   ?>
                                    ...
                                    <!-- end slideshow -->
                                    <div class="event__thumb-date" style="z-index: 10;">
                                        <?php $date=explode('-', $festi->date); $months = array(1 => 'Jan', 2 => 'Feb', 3 => 'Mar', 4 => 'Apr', 5 => 'May', 6 => 'Jun', 7 => 'Jul', 8 => 'Aug', 9 => 'Sep', 10 => 'Oct', 11 => 'Nov', 12 => 'Dec');
                                        $day="<h6>".$date[0]."</h6>";
                                        $month_num=$date[1];
                                        $mon="<p>".$months[(int)$month_num]."</p>";
                                        $year="<p>".$date[2]."</p>";
                                ...
                                <div class="event__content">
                                    <a href="/user/eventsdetail_page/{{$festi->id}}"><h5>{{$festi->title}}</h5></a>
                                    <div class="event__metapost">
                                        <ul class="event__metapost-info">
                                            <li><i class="far fa-clock"></i>{{$festi->time}}</li>
                                            <li><i class="fas fa-map-marker-alt"></i>New mariyamman govil</li>
                                        </ul>
      ...
      <button class="pagination-next btn btn-primary">Next</button>
    </div>
            </div>
        </div>
    </div>
