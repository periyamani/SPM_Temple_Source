...
<!-- Mirrored from demos.codexcoder.com/themeforest/html/peace/peace/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Mar 2022 09:14:02 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
                        ...
                        <div class="collapse navbar-collapse" id="menubar">
                            <ul>
                                <li class="active">
                                    <a href="#0">Home</a>
                                    <ul>
                                        <li><a href="index.html" class="active">Home Page Christian</a></li>
    ...
    <div class="shedule padding--top padding--bottom bg-img" style="background-image: url(assets/images/bg-img/01.jpg);">
        <div class="container">
            <div class="row g-4">
    ...
    <div class="cause padding--top padding--bottom bg-img" style="background: url(assets/images/bg-img/02.jpg) rgba(0, 0, 0, .4);">
        <div class="container">
            <div class="section__header text-center">
                                ...
                                <div class="blog__slider overflow-hidden">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="blog__slider-item">
                                                <div class="blog__slider-thumb">
                                                    <a href="blog-single.html"><img src="assets/images/blog/slider/01.jpg" alt="blog thumb"></a>
                                                </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="blog__slider-item">
                                                <div class="blog__slider-thumb">
                                                    <a href="blog-single.html"><img src="assets/images/blog/slider/02.jpg" alt="blog thumb"></a>
                                                </div>
                                                <div class="blog__slider-content">
                                                    <a href="blog-single.html"><h6>Lorem Ipsum Dolor.</h6></a>
                                                    <p class="blog__slider-rating">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="blog__slider-item">
                                                <div class="blog__slider-thumb">
                                                    <a href="blog-single.html"><img src="assets/images/blog/slider/03.jpg" alt="blog thumb"></a>
                                                </div>
                                                <div class="blog__slider-content">
                                                    <a href="blog-single.html"><h6>Lorem Ipsum Dolor.</h6></a>
                                                    <p class="blog__slider-rating">
    ...
    <div class="qoute padding--top padding--bottom bg-img" style="background: url(assets/images/bg-img/03.jpg) rgba(0, 0, 0, .4);;">
        <div class="container">
...
<!-- Mirrored from demos.codexcoder.com/themeforest/html/peace/peace/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Mar 2022 09:14:29 GMT -->
</html>