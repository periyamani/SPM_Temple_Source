...
<h4 class="py-3 breadcrumb-wrapper mb-4">
  <span class="text-muted fw-light">Dashboard /</span> Festivals
</h4>
@if(in_array('festival',$permissionArray))
<!-- Bootstrap modals -->
<div class="card radius-15">
<div class="card-body"> 
  <h5 class="card-header">Add Festivals  @if(in_array('add_festival_button',$permissionArray)) <button type="button" class="btn btn-primary ms-3 add_model_op">Add</button>@endif</h5> 
...
@endif
          <!-- / model -->
 <!-- Modal -->
 @if(in_array('add_festival_button',$permissionArray))
 <div class="modal fade" id="addmodel" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel1">Add Festivals</h5>
                ...
                <div class="row g-2">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                    <label for="nameBasic" class="form-label">Photo and video upload <span class="photo_alert star" style="color:red;">*</span></label>
                    <div>
 ...
 <div class="modal fade" id="editmodel" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel1">Edit Festivals</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                @if(in_array('update_festival_button',$permissionArray))
                <form id="Editform">
                <div class="row g-2">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                    <label for="nameBasic" class="form-label">Photo and video upload</label>
                    <div>
...
@endif
          ...
          @if(in_array('delete_festival_button',$permissionArray))
...
<script src="{{URL::asset('admin/js/festival.js')}}"></script>
