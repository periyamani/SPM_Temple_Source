          ...
          success: function(data) {
              ...
              $.each(data, function(key, val) {
                  if(val.child_number==0){
                      ...
                      +'<div class="pt-thumb">'
                      +'<img src="poosari/'+val.photo+'" style="width: 100%; height: 100%;">'
                      +'</div>'
         ...
         if (result.value) {
          deletepoosari(ID);
           Swal.fire({
             icon: 'success',
             title: 'Delete',
             text: 'Your poosari has been deleted.',
             customClass: {
           ...
           Swal.fire({
             title: 'Cancelled',
             text: 'Your poosari file is safe',
             icon: 'error',
             customClass: {
               confirmButton: 'btn btn-success'
             }
...
function editpoosari(child){
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $(".editimage_show").attr({"src" : "poosari/"+val.photo});
            $("#remove_image").show();
