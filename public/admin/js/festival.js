            ...
            $.each(data, function(key, val) {
                ...
                for (let i = 0; i < image.length; i++) {
                    ...
                    if (formate[1] === 'jpg' || formate[1] === 'png') {
                        count++;
                        $(".edit_input_file").append('<div class="col-sm-4 mb-3 remove10' + count + ' "><div class="crad text-center" style="background:#efefef;"><img class="image_align" src="festival/' + image[i] + '"><hr class="hr_margin"><div class="file_name">' + image[i] + '</div><hr class="hr_margin">' +
                        ...
                        count++;
                        $(".edit_input_file").append('<div class="col-sm-4 mb-3 remove20' + count + '"><div class="crad text-center" style="background:#efefef;"><video class="image_align" controls src="festival/' + image[i] + '"></video><hr class="hr_margin"><div class="file_name">' + image[i] + '</div><hr class="hr_margin">' +
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Delete',
                    text: 'Your festival has been deleted.',
                    customClass: {
                ...
                Swal.fire({
                    title: 'Cancelled',
                    text: 'Your festival file is safe',
                    icon: 'error',
                    customClass: {
                        confirmButton: 'btn btn-success'
                    }
